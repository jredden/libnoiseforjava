...
public String toString() {
	return "Cached [cachedValue=" + cachedValue + ", isCached=" + isCached + ", xCache=" + xCache + ", yCache=" + yCache
			+ ", zCache=" + zCache + ", sourceModules=" + Arrays.toString(sourceModules) + ", modulesRequired="
			+ modulesRequired + "]";
}
